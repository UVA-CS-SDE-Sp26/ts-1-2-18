 ...
 * decipher method is tested against same and different sized cipher and actual variables,
 * invalid or empty global variables, and correctness
 * the accessor methods for both global variables are tested for correctness and efficiency
